...
api_key_geo = "4b48e8d03f1aede58b50beff49f35b92"  # API ключ для гео-запросов, если используется отдельный сервис
...
m = Basemap(projection='merc', llcrnrlat=40, urcrnrlat=50, llcrnrlon=30, urcrnrlon=50, resolution='i')
...
for city, info in data.items():
    ...
    plt.text(x, y, f"{city}\n{info['temp']}°C", fontsize=10, ha='center', va='center', bbox=dict(facecolor='white', alpha=0.6, edgecolor='black'))

# Показываем карту
plt.title('Current Temperature in Cities around Krasnodar')
plt.show()